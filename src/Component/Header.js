                        ...
                        <div className='s_submenu '>
                            ...
                            <div className='s_submenu_list'>
                                ...
                                {menSilver.map((ele, id) => {
                                    return (
                                        <Link to={`/productlist/silver/men/${ele.sub_category_name}`} key={ele.id}><img alt={ele.sub_category_name} src={ele.images[0]} className='ms-0'></img>{ele.sub_category_name}</Link>
                                    )
                                })}
                            </div>
                            <div className='s_submenu_list'>
