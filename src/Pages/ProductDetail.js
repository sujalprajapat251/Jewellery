...
function ProductDetail() {
  ...
  useEffect(() => {
    const product_review = reviews?.filter(
  ...
  const color = [
    { name: "rose", code: "#B76E79" },
    { name: "gold", code: "#FFD700" },
    { name: "silver", code: "#C0C0C0" },
    { name: "platinum", code: "#e5e4e2" },
    { name: "white-gold", code: "#FFFFF4" },
    { name: "yellow-gold", code: "##FFDF00" },
  ];
  let metalColor = [];
  ...
  const buyNowHandling = () => {
    ...
    const tax = (
      ((parseFloat(product?.total_price) - discount) * 3) /
      100
    ).toFixed(2);
  ...
  const handleAddToWishlist = (itemId) => {
    ...
    setTimeout(() => {
      setLoadingItems((prev) =>
        prev.filter((loadingItem) => loadingItem !== itemId)
      );
    }, 2000);
  };
    ...
    <>
      <section className="s_prodetail_page ds_container">
        ...
        <Row lg={2} className="gx-0 gx-md-4 pt-lg-4 pb-4 row-cols-1">
            ...
            {thumbnail !== null ? (
              ...
              <div className="s_product_img d-flex flex-wrap">
                {[...Array(4)].map((_, index) => {
                  ...
                  const isImage =
                    media && /\.(jpg|jpeg|png|gif|bmp|svg|webp)$/i.test(media);

                  return media ? (
                    isVideo ? (
                      <div className="s_product_video" onMouseLeave={handleStopclick} key={`video-${index}`}>
                    ...
                    <div className="s_blank_img">
                      <div className="s_product-image"></div>
                    </div>
                  );
                })}
              </div>
          ...
          <Col>
            <div className="s_productdetail_sec ">
              ...
              <h3 className="s_title text-capitalize text-center text-lg-start ">
              ...
              <div className="d-flex align-items-center justify-content-center justify-content-lg-start">
                <h2 className="s_price text-center text-lg-start">
                  ₹ {parseFloat(product?.price_with_gst).toFixed(2)}
                </h2>
                {inStock === true ? (
                  ""
                ) : (
                  <div className="s_stock_status">out of stack</div>
                )}
              </div>
              <p className="s_description text-center text-lg-start">
                {product?.description}
              </p>
              ...
              <div className="s_other_info">
                ...
                <p>
                  Physical Damage, Defective, Wrong and missing item and any
                  other reason
                </p>
        ...
        <div className="s_other_sec ">
          ...
          <div
            className={`s_table_sec d-lg-flex  px-0 ${tab === "tab-0" ? "" : "d-none d-lg-none"}`}>
            {product.category_name !== "Watch" ? (
              <>
                ...
                <div className="s_table s_w_40">
                  ...
                  <span className="d-flex justify-content-between">
                    <p>Setting</p>
                    <b>
                      {product?.diamond_setting ? product.diamond_setting.replace(/,/g, ", ") : "-"}
                    </b>
                  </span>
                  <span className="d-flex justify-content-between">
                    <p>Color</p>
                    <b>{product?.diamond_color || "-"}</b>
                  </span>
                  <span className="d-flex justify-content-between">
                    <p>Shape</p>
                    <b>{product?.diamond_shape || "-"}</b>
                  </span>
                  <span className="d-flex justify-content-between">
                    <p>No. of Diamonds</p>
                    <b>{product?.no_of_diamonds || "-"}</b>
                  </span>
                </div>
                <div className="s_table s_w_30">
                  ...
                  <span className="d-flex justify-content-between">
                    <p>Occasion</p>
                    <b>{product?.occasion || "-"}</b>
                  </span>
                  <span className="d-flex justify-content-between word-wrap">
                    <p>Size</p>
                    <b>{sizeArray.map((item) => item).join(", ") || "-"}</b>
                  </span>
                </div>
              </>
            ) : (
              <>
                <div className="s_table s_w_30">
                  ...
                  <span className="d-flex justify-content-between">
                    <p>Size</p>
                    <b>{product?.size ? `${product.size}mm` : "-"}</b>
                  </span>
                  <span className="d-flex justify-content-between">
                    <p>Water Resistant</p>
                    <b>
                      {product?.water_resistant ? `${product.water_resistant} Meter` : "-"}
                    </b>
                  </span>
                  <span className="d-flex justify-content-between">
                    <p>Case Material</p>
                    <b>
                      {product?.cash_material ? `${product.cash_material}` : "-"}
                    </b>
                  </span>
                  <span className="d-flex justify-content-between">
                    <p>Dial Color</p>
                    <b>
                      {product?.metal_color ? `${product.metal_color}` : "-"}
                    </b>
                  </span>
                </div>
                <div className="s_table s_w_40">
                  ...
                  <span className="d-flex justify-content-between">
                    <p>Movement</p>
                    <b>{product?.movement ? `${product.movement}` : "-"}</b>
                  </span>
                  <span className="d-flex justify-content-between">
                    <p>Clasp Type</p>
                    <b>{product?.clasp_type ? `${product.clasp_type}` : "-"}</b>
                  </span>
                  <span className="d-flex justify-content-between">
                    <p>Occasion</p>
                    <b>{product?.occasion ? `${product.occasion}` : "-"}</b>
                  </span>
                </div>
                <div className="s_table s_w_30">
                  ...
                  <span className="d-flex justify-content-between">
                    ...
                    <b>
                      {product?.reference_number ? `${product.reference_number}` : "-"}
                    </b>
                  </span>
                  <span className="d-flex justify-content-between">
                    <p>Warranty</p>
                    <b>
                      {product?.warranty ? `${product.warranty} Manufacturer Warranty` : "-"}
                    </b>
                  </span>
                </div>
              </>
          ...
          <div
            className={`overflow-x-auto s_table_sec d-lg-flex ${tab === "tab-1" ? "" : "d-none d-lg-none"}`}>
            <table className="">
              <thead>
                <tr>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    {product?.price ? `₹ ${(product?.price / product?.weight).toFixed(2)}/g` : "-"}
                  </td>
                ...
                <tr>
                  <td>Stone</td>
                  <td>
                    {product?.stone_price ? `₹ ${product?.stone_price}/g` : "-"}
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    {product?.making_charge ? `${product?.making_charge}%` : "-"}
                  </td>
                  <td>-</td>
                  <td>-</td>
                  <td>₹ {making_charge}</td>
        ...
        <div className="s_also_like">
          <div className="d-flex justify-content-between">
            ...
            <Link to={`/productlist/category/${product?.category_name}`}>
              View More
            </Link>
          </div>
          <div>
                    ...
                    <div className="s_seller_card d-flex flex-column">
...

                      {
                        loadingItems.includes(ele.id) ? (
                          <div className="loading s_heart_icon">
                            <svg height="24px" width="32px">
                              {" "}
                              {/* Adjusted height and width */}
                              <polyline id="back" points="0.157 11.977, 14 11.977, 21.843 24, 43 0, 50 12, 64 12"></polyline>
                              <polyline id="front" points="0.157 11.977, 14 11.977, 21.843 24, 43 0, 50 12, 64 12"></polyline>
                            </svg>
                          </div>
                      ...
                      <div className="s_card_text">
                        <Link to={`/productdetail/${ele.id}`}>
                          ...
                          <p className="mb-0">
                            <span className="mx-2">₹ {parseFloat(ele.price_with_gst).toFixed(0)}</span>
                            <strike className="mx-2">₹ {discountPrice}</strike>
                          </p>
                    ...
                    <div className="s_seller_card d-flex flex-column">
                      ...
                      <div className="s_card_text">
                        <Link to={`/productdetail/${ele.id}`}>
                          ...
                          <p className="mb-0">
                            <span className="mx-2">
                              ₹ {parseFloat(ele.price_with_gst).toFixed(0)}
                            </span>
                            <strike className="mx-2">₹ {discountPrice}</strike>
                          </p>
      ...
      <Modal className="s_review_modal" size="xl" show={lgShow} onHide={() => setLgShow(false)} aria-labelledby="example-modal-sizes-title-lg" scrollable>
      ...
      <Login isOpen={showLogin} onClose={() => handleLoginClose()} onOpen={() => handleLoginShow()}></Login>

      {/* share link modal */}
      <Modal className="s_share_madal" show={shareModal} onHide={() => setShareModal(false)} centered>
